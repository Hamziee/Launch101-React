    ...
    <div className="download-container">
      ...
      <header data-role="Header" className="download-header">
        <Link to="/" className="download-navlink">
          <img alt="logo" src="/logo-200h.png" className="download-image" />
        </Link>
        ...
        <div className="download-btn-group">
          <a
            href="https://github.com/HEO-Systems/Launch101/releases/download/latest/Launch101_Setup.msi"
            target="_blank"
        ...
        <div data-role="BurgerMenu" className="download-burger-menu">
        ...
        <div data-role="MobileMenu" className="download-mobile-menu">
          <div className="download-nav1">
            <div className="download-container1">
              ...
              />
              <div data-role="CloseMobileMenu" className="download-menu-close">
                <svg viewBox="0 0 1024 1024" className="download-icon02">
